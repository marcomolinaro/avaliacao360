...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "avaliacao@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "avaliacao API";

        private String description = "avaliacao API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "avaliacao";
